...
UserSchema.methods.createUser = function (fullName, userId, phone, email, password, singleFlag, agentType, superAgent, isAgent, actualBalance, bonusBalance) {
    this.salt = crypto.randomBytes(16).toString('hex');
    ...
    this.totalBalance = actualBalance + bonusBalance
...
uploadSchema.methods.createUpload = function (title, text) {
    this.title = title
    this.text = text
}
