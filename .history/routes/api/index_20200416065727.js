...
function fileFilter (req, file, cb, res){
    var type = file.mimetype;
    var typeArray = type.split("/");
    ...
    // ServerErrorResponse.error_string = "Error! Something went wrong. Request could not continue."
     //res.status(SERVER_ERROR_RESPONSE_CODE).json({status:false, error_string: "Error! Something went wrong. Please retry action"})//
    // userController.handleErrorServer(null, res, "Error! Something went wrong. Please retry action")
    }
  }
