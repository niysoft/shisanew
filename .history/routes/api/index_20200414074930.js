...
const storage = multer.diskStorage({
    ...
    filename: function (req, file, cb) {
        ...
        let filename = req.body.email + "_" + req.body.caseid + "_" + req.body.incidentid + "_" + Date.now() + path.extname(file.originalname)//req.cookies.incidentId//JSON.parse(req.cookies.userData)
