...
module.exports.upload_files = function (req, res, next) {
    ...
    if (!req.body && !req.files || req.files.length === 0) {
        handleErrorServer(null, res,  req.headers.error)//"Only image files are allowed. Click other tabs for more upload file types"
    } else {
        var c;
                                            ...
                                            .then(image => {
                                                ...
                                                Upload.find(
                                                    ...
                                                    .then(video => {
                                                        ...
                                                        SuccessResponse.audios = video
                                                        SuccessResponse.others = []
                                                        res.status(SUCCESS_RESPONSE_CODE).json(SuccessResponse)
                                                    }).catch(function (err) {
